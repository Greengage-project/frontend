    ...
    <>
      ...
      <div>
        <HomeRow
          ...
          right={
            <div>
              <Typography variant="h4">{t("home-platform-1")}</Typography>
              <Typography
                color="textSecondary"
        ...
        <HomeRow
          ...
          right={
            <div>
              <Typography variant="h4">{t("home-platform-2")}</Typography>
              <Typography
                color="textSecondary"
                sx={{ my: 3, textAlign: "justify" }}
                variant="subtitle1"
        ...
        <HomeRow
          ...
          right={
            <div>
              <Typography variant="h4">{t("home-platform-3")}</Typography>
              <Typography
                color="textSecondary"
                sx={{ my: 3, textAlign: "justify" }}
                variant="subtitle1"
