        ...
        {usernotifications.length === 0 ? (
          <Box sx={{ p: 2 }}>
            <Typography
              color="textPrimary"
              variant="subtitle2"
              data-cy="there_are_no_notifications"
            >
                ...
                return (
                  <ListItem divider key={usernotification.id}>
                    ...
                    <ListItemText
                      primary={
                        <Link
                          href={includeParametersValues(
                            usernotification.notification.url_link,
